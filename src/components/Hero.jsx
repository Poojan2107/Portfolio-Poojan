      ...
      <div className="container" style={{ 
        ...
        >
          ...
          <motion.h1 variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} style={{ fontSize: '4.5rem', fontWeight: '800', lineHeight: '1.1', marginBottom: '1rem', letterSpacing: '-2px' }}>
            ...
            <span className="gradient-text">{PERSONAL_DETAILS.name.split(' ')[1]}</span>
          </motion.h1>
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} style={{ display: 'flex', gap: '1.5rem' }}>
            <a href="#projects" className="btn btn-primary" style={{ textDecoration: 'none', color: '#000', padding: '1rem 2.5rem', fontSize: '1.1rem' }}>View Projects</a>
            <a href="#contact" className="btn btn-outline" style={{ textDecoration: 'none', padding: '1rem 2.5rem', fontSize: '1.1rem' }}>Contact Me</a>
          </motion.div>
        </motion.div>
